  ...
  return (
    <section className="footer__container">
      <div className="footer__up">
        ...
        <div className="f__center">
          <Link to={"/privacy"} onClick={() => sessionStorage.setItem('location', '/privacy')}> Terms and conditions</Link>
          <Link to={"/privacy"} onClick={() => sessionStorage.setItem('location', '/privacy')}> Return and Refund Policy</Link>
          <Link to={"/privacy"} onClick={() => sessionStorage.setItem('location', '/privacy')}>Shipping and Delivery Policy</Link>
        </div>
        <div className="f__center">
       
          <Link to={"/contact"} onClick={() => sessionStorage.setItem('location', '/contact')}> Twitter</Link>
          <Link to={"/contact"} onClick={() => sessionStorage.setItem('location', '/contact')}>  Instagram</Link>
          <Link to={"/privacy"} onClick={() => sessionStorage.setItem('location', '/privacy')}>LinkedIn</Link>
        </div>
      </div>

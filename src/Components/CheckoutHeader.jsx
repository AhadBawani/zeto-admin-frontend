...
const CheckoutHeader = () => {
  ...
  return (
    <nav className="navbar checkout_header">
      <Link to={"/"} onClick={() => sessionStorage.setItem('location', '/')}>Back to Store</Link>
        ...
        {user ? (
          <div className="userAfterLogin">
            ...
            >
              <ul>
                <li>
                  <Link to="/order" onClick={() => sessionStorage.setItem('location', '/order')}>Order</Link>
                </li>
                <li>
                  <Link to="/profile" onClick={() => sessionStorage.setItem('location', '/prodfile')}>Profile</Link>
                </li>

...
const Checkout = () => {
   ...
   useEffect(() => {
      dispatch(AddressSubmitAction({ college: "Select College", hostel: "Select Hostel", room_no: 0 }));
      axios
         ...
         <div className="checkout__page">
            <div className="check__left">
               {!user ? (
                  <div className="checkout__card">
                     <h2>
                        {user
                           ? "1.Account Details"
                           : "1.You need to SignIn/SignUp"}
                     </h2>
                     {forgotpwd ? <ForgotPassword /> : <SignUpDialog />}
                  </div>
               ) : (
                  ...
                  <div className="checkout__shipping">
                     <details
                        onClick={() => {
                           ...
                           dispatch(EditInfoToggleBtnAction("address"))
                        }
                        }
                     >
                        <summary>{address?.college}</summary>
                     </details>
                     <details
                        onClick={() =>
                           dispatch(EditInfoToggleBtnAction("address"))
                     ...
                     >
                        <summary>{address?.hostel}</summary>
                     </details>
                     <details
                        onClick={() =>
               ...
               <div className="order-confirm-policy">
                  <input type="checkbox" checked={checked} onChange={alertHandler} id="alert" />
                  <label htmlFor="alert">Once order placed, you can't cancel.</label>
               </div>
               <div
                  className="checkoutBtn"
                  style={
                     (time <= orderLimit) && user && checked
                        ? { cursor: "pointer" }
                        : {
                           cursor: "pointer",
                           pointerEvents: "none",
               ...
               >
                  <span>Checkout</span>
                  <span>
                     <img src={rupee} alt="" /> {Math.round(total) + deliveryFee}
                  </span>
               </div>
            </div>
            ...
            <div
               ...
               onClick={() => PlaceOrder()}
               className="checkoutBtn checkoutMob"
            >

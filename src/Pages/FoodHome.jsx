              ...
              <section ref={ref1}>
                {
                  category && category?.filter(i => i?.sellerId == seller?._id)?.map(category => {
                    return <section className="food_slider">
                      ...
                      <div className="fs_items" >
                        {foodProducts &&
                          foodProducts?.filter(item => item?.subCategoryId?._id == category?._id)?.map((item) => {
                            return (
                              <div className={item?.disabled ? "fs_item_card disabled" : "fs_item_card"}>

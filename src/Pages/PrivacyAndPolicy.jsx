...
const PrivacyAndPolicy = () => {
  ...
  return (
    <>
      <section className="pap">
        <CheackoutHeader />
        <section className="pap-container">
          <div className="pap-header">
            <h1>Privacy Policy</h1>
            <span>Last Updated Jan 20, 2023</span>
          </div>
          <div className="pap-body">
            <div className="pap-left">
              <h2 id="0"> 1. Introduction</h2>
              <p>Welcome to Zetomart.</p>
              <p>
                Zetomart (“us”, “we”, or “our”) operates
                https://www.zetomart.com (hereinafter referred to as “Service”).
              </p>
              <p>
                Our Privacy Policy governs your visit to
                https://www.zetomart.com, and explains how we collect, safeguard
              ...
              <h2 id="1">2. Definitions</h2>
              <p>
                <span>SERVICE</span> means the https://www.zetomart.com website
                operated by Zetomart.
              </p>
              <p>
                <span>PERSONAL DATA </span> means data about a living individual
              ...
              <p>
                <span>COOKIES</span> are small files stored on your device
                (computer or mobile device).
              </p>
              <p>
                <span> DATA CONTROLLER</span> means a natural or legal person
              ...
              <p>
                ...
                Providers in order to process your data more effectively. <br />
              </p>
              <p>
              ...
              <p>
                <span> THE USER</span> is the individual using our Service. The
                User corresponds to the Data Subject, who is the subject of
                Personal Data.
              </p>

              <h2 id="2">3.Information Collection and Use</h2>
              <p>
                We collect several different types of information for various
                purposes to provide and improve our Service to you.
              </p>
              <h2 id="3">4. Types of Data Collected</h2>
              ...
              <p>
                ...
                us permission to do so (“ <span>Location Data</span> ”). We use
              ...
              <p>
                0.1. <span>Session Cookies</span>: We use Session Cookies to
                operate our Service.
              </p>
              <p>
                0.2. <span>Preference Cookies</span>: We use Preference Cookies
                to remember your preferences and various settings.
              </p>
              <p>
                0.3. <span>Security Cookies</span>: We use Security Cookies for
                security purposes.
              </p>
              <p>
                0.4. <span>Advertising Cookies</span>: Advertising Cookies are
              ...
              <h2 id="4">5. Use of Data</h2>
              <p>Zetomart uses the collected data for various purposes:</p>
              <p>Zetomart uses the collected data for various purposes:</p>
              ...
              <h2 id="5">6. Retention of Data</h2>
              <p>
              ...
              <p>
                Zetomart will take all the steps reasonably necessary to ensure
              ...
              <h2 id="7">8. Disclosure of Data</h2>
              <p>
                We may disclose personal information that we collect, or you
                provide:
              </p>
              <span>0.1. Disclosure for Law Enforcement.</span>
              <p>
              ...
              <span>0.2. Business Transaction.</span>
              <p>
              ...
              <p>
                ...
                us at <span>zeto@zetomart.com.</span>
              </p>
              <p>
              ...
              <p>
                ...
                Privacy Policy Page; 0.4. users are able to change their
                personal information by emailing us at zeto@zetomart.com. Our
              ...
              <p>
                ...
                Preferences or Settings page of your web browse
              </p>
              <h2 id="11">
              ...
              <p>
                f you are a California resident, you are entitled to learn what
              ...
              <h2 id="12">13. Service Providers</h2>
              <p>
                We may employ third party companies and individuals to
                facilitate our Service (“ <span>Service Providers</span> ”),
              ...
              <h2 id="17">18. Links to Other Sites</h2>
              <p>
              ...
              <h2 id="18">19. Children’s Privacy</h2>
              <p>
                Our Services are not intended for use by children under the age
                of 18 (“ <span>Child</span> ” or “ <span>Children</span> ”).
              </p>
              <p>
              ...
              <h2 id="19">20. Changes to This Privacy Policy</h2>
              <p>

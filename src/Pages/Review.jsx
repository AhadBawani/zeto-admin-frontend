...
const Review = () => {
  ...
  const sellerReview = useSelector((state) => state?.Products?.seller_review);
    ...
    <section className="review">
      ...
      <section className="r-body">
            ...
            {review?.map((i, j) => {
              return (
                <div>
                  ...
                  <span>{i?((100 * i) / sellerReview?.review?.length):0}%</span>
                </div>
              );
            })}
          </div>
        ...
        <div className="r-right">
          ...
          {sellerReview?.review&&sellerReview?.review?.map((i) => {
            return (
